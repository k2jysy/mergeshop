...
if (isset ( $_GET ['func_nm'] ) && $_GET ['func_nm'] == 'exportCsvWoo') {
    ...
    switch ( $active_module ) {
        ...
        case 'Customers':
                ...
                $columns_header['_billing_address']     = __('Address', $sm_text_domain);
        ...
        case 'Orders':
                ...
                $columns_header['_shipping_address']        = __('Shipping Address', $sm_text_domain);
                ...
                $columns_header['order_note']               = __('Order Notes', $sm_text_domain);
            break;
    }
