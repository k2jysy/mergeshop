...
class Smart_Manager_Admin_Welcome {
	...
	public function admin_menus() {
		...
		$welcome_page_name  = __( 'About Smart Manager', self::$text_domain );
		$welcome_page_title = __( 'Welcome to Smart Manager', self::$text_domain );
	...
	private function intro() {
		...
		<h3><?php _e("Thanks for installing! We hope you enjoy using Smart Manager.", self::$text_domain); ?></h3>

		<div class="feature-section col two-col"><br>
			<div class="col-1">
				<!-- <p class="woocommerce-actions"> -->
					<a href="<?php echo $this->sm_redirect_url; ?>" class="button button-primary"><?php _e( 'Get Started!', self::$text_domain ); ?></a>
					<a href="options-general.php?page=smart-manager-settings" class="button button-primary" target="_blank"><?php _e( 'Settings', self::$text_domain ); ?></a>
					<a href="http://www.storeapps.org/support/documentation/smart-manager" class="docs button button-primary" target="_blank"><?php _e( 'Docs', self::$text_domain ); ?></a>
				<!-- </p> -->
			</div>
		</div>
